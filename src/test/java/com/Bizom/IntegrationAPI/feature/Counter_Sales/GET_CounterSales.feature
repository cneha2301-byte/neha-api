@Sales @Sanity @All @allGet @Execution
Feature: This feature file is of the testcases of GET end point of list counter sales
  ...
  Scenario: TC_01 get counter sales positive
    ...
    And I send the GET request to "list_counter_sales" endpoint with dynamic access token and query parameters
    ...
    And I store the response as "counterSalesList" name using xml full path
...
#-------------------------------------------------------------------------------------------------
  ...
  Scenario: TC_02 query parameters is missing
    ...
    Then I should see the response code as "200"
    And I store the response as "counterSalesList" name using full path
